...
| sql\_database\_requested\_service\_objective\_id\_enabled | Boolean flag which descibes whether to enable the service objective ID or not. | `list(bool)` | <pre>[<br>  false<br>]</pre> | no |
